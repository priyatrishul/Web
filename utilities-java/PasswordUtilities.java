...
public class PasswordUtilities {
   ...
   public static void main(String [] args) {
   	...
   	PasswordUtilities.addEntryToPasswordFile("jadrn043","abc");	
	PasswordUtilities.addEntryToPasswordFile("abc","abc");
	PasswordUtilities.addEntryToPasswordFile("jbrown","abc");
	}
