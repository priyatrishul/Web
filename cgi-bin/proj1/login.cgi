...
sub authenticate_user {
    ...
    open DATA, "</srv/www/cgi-bin/jadrn043/proj1/passwords.dat" 
...
# WATCH YOUR COOKIE NAMES! USE JADRNXXX_SID  
    ...
    $session->expires('+1d');
    my $cookie = $q->cookie(jadrn043SID => $session->id);
...
<head>
    <meta http-equiv="refresh" 
        content="0; url=http://jadran.sdsu.edu/~jadrn043/proj1/ajax_upload/form_upload_ajax.html" /> 
</head>
<body>
</body>
</html>
