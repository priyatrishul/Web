...
public class GetVendProducts extends HttpServlet {
	...
	String query = "SELECT product.sku, vendor.name,category.name, vendorModel," +
    	...
    	"category.categoryID = product.catID AND vendor.vendorID = product.venID AND on_hand.sku = product.sku and vendor.vendorID="+vend;
